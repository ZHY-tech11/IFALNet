...
if dataset == 'sysu':
    data_path = '/gemini/data-1/SYSU-MM01/'
    n_class = 395
    test_mode = [1, 2]
elif dataset =='regdb':
...
cmc2, mAP2, mINP2 = all_cmc2 / 10, all_mAP2 / 10, all_mINP2 / 10
cmc3, mAP3, mINP3 = all_cmc3 / 10, all_mAP3 / 10, all_mINP3 / 10
cmc4, mAP4, mINP4 = all_cmc4 / 10, all_mAP4 / 10, all_mINP4 / 10
cmc5, mAP5, mINP5 = all_cmc5 / 10, all_mAP5 / 10, all_mINP5 / 10
cmc, mAP, mINP = all_cmc / 10, all_mAP / 10, all_mINP / 10
